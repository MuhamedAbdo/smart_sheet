...
class ProductionReportAdapter extends TypeAdapter<ProductionReport> {
  ...
  ProductionReport read(BinaryReader reader) {
    ...
    return ProductionReport(
      ...
      product: fields[3] == null ? '' : fields[3] as String,
      productCode: fields[4] == null ? '' : fields[4] as String,
      dimensions: fields[5] == null ? {} : (fields[5] as Map).cast<String, dynamic>(),
      colors: fields[6] == null ? [] : (fields[6] as List).cast<dynamic>(),
      quantity: fields[7] == null ? 0 : fields[7] as int,
