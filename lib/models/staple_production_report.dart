...
part 'staple_production_report.g.dart';

@HiveType(typeId: 27)
class StapleProductionReport extends HiveObject {
  @HiveField(0)
  final String id;
  ...
  @HiveField(19, defaultValue: 'approved')
  final String status;

  StapleProductionReport({
    required this.id,
  ...
  StapleProductionReport copyWith({
    String? id,
    String? machineName,
  ...
  factory StapleProductionReport.fromJson(Map<String, dynamic> map) {
    return StapleProductionReport(
