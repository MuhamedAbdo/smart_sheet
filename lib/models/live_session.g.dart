...
class LiveSessionAdapter extends TypeAdapter<LiveSession> {
  ...
  LiveSession read(BinaryReader reader) {
    ...
    return LiveSession(
      ...
      machineName: fields[1] == null ? '' : fields[1] as String,
      clientName: fields[2] == null ? '' : fields[2] as String,
      productName: fields[3] == null ? '' : fields[3] as String,
      productCode: fields[4] == null ? '' : fields[4] as String,
      orderNumber: fields[5] == null ? '' : fields[5] as String,
      technicianName: fields[6] == null ? '' : fields[6] as String,
      startTime: fields[7] == null ? DateTime.now() : fields[7] as DateTime,
      downtimeIntervals: fields[8] == null ? [] : (fields[8] as List).cast<DowntimeInterval>(),
      isRunning: fields[9] == null ? true : fields[9] as bool,
      lastStateChange: fields[10] == null ? DateTime.now() : fields[10] as DateTime,
      ...
      department: fields[17] as String? ?? 'flexo',
