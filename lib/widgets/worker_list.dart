...
class WorkerList extends StatelessWidget {
  ...
  /// المجموعة 1 → الإدارة العليا ورؤساء الأقسام (تظهر أولاً)
  /// المجموعة 2 → الوظائف الإشرافية والتنفيذية الأولى
  /// المجموعة 3 → الفنيون والتجهيزات والمراقبة
  /// المجموعة 4 → المساعدون والدعم اللوجستي والمبيعات
  /// المجموعة 5 → العمال والحركة والأمن (تظهر أخيراً)
  int _getJobWeight(String? job) {
    switch (job?.trim()) {
      // ─── المجموعة 1: الإدارة العليا ورؤساء الأقسام ───────────────────────
      case 'مدير الإنتاج':
      case 'مدير حسابات':
      case 'مدير مخازن':
      case 'مدير الجودة':
      ...
      // ─── المجموعة 2: الوظائف الإشرافية والتنفيذية الأولى ─────────────────
      case 'مشرف عام الإنتاج':
      case 'مشرف':
      case 'مشرف القسم':
      case 'سكرتارية تنفيذية':
      case 'مدير مبيعات':
      case 'مدير HR / شؤون عاملين':
        return 2;

      // ─── المجموعة 3: الفنيون والتجهيزات والمراقبة ────────────────────────
      case 'فني مونتاج أكلاشيهات':
      case 'فني فورم وتكسير':
      case 'فني عينات / تصميم':
      case 'محاسب عملاء':
      case 'محاسب موردين':
      case 'أمين مخزن رولات':
      case 'أمين مخزن إنتاج تام':
      case 'أمين مخزن خامات مساعدة':
      case 'مراقب جودة (صالة الإنتاج)':
      case 'فني مختبر / معمل':
      case 'مسؤول إصدار أوامر التشغيل':
      case 'فني':
        return 3;
      ...
      case 'مساعد':
      case 'خزينة / كاشير':
      case 'مسؤول مبيعات / مندوب':
      case 'موظف إداري':
      case 'مدخل بيانات إداري':
        return 4;

      // ─── المجموعة 5: العمال والحركة والأمن ───────────────────────────────
      case 'عامل':
      case 'سائق كلارك':
      case 'عامل إنتاج':
      case 'فرد أمن':
      ...
      default:
        return 6; // أي وظائف أخرى غير معرّفة تظهر في النهاية
    }
  }
}
